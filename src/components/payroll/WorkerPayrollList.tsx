...
export function WorkerPayrollList({ workers, attendance, selectedPeriod, paidWorkers = new Set(), onTogglePaid, onDelete }: WorkerPayrollListProps) {
  ...
  return (
    <Card className="bg-white dark:bg-[#111827] rounded-xl p-4 md:p-6 shadow-lg border border-slate-200 dark:border-slate-800">
      <div className="mb-6">
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-4 md:gap-4">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {onDelete && (
                        <Button
                          ...
                          className="h-6 w-6 p-0 text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-900/20 flex-shrink-0"
                        >
                ...
                {/* Mobile: Grid Layout */}
                <div className="md:hidden grid grid-cols-2 gap-3 pt-3 border-t border-slate-200 dark:border-slate-700">
                  <div className="text-left">
                    <div className="flex items-center gap-1 text-slate-500 dark:text-slate-400 mb-1">
                      <Calendar className="h-3.5 w-3.5" />
                      <p className="text-xs">Days</p>
                  ...
                  <div className="text-left">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-1">Net Total</p>
                  ...
                  {onTogglePaid && (
                    <div className="col-span-2 text-left pt-2 border-t border-slate-200 dark:border-slate-700">
                      <div className="flex items-center gap-2">
                        <Checkbox
                          checked={paidWorkers.has(worker.id)}
                          onCheckedChange={() => onTogglePaid(worker.id)}
                          className="h-5 w-5"
                        />
                        <p className="text-sm text-slate-500 dark:text-slate-400">Mark as paid</p>
                      </div>
                    </div>
                  )}
                </div>
